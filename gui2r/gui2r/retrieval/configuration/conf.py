...
class Configuration():
    ...
    def __init__(self, path_guis: Optional[Text] = '../../resources/combined_small/',
                 ...
                 path_ui_comp_data: Optional[Text] = '/ui_comps_text/all_ui_comps.csv',
                 path_ui_comp_models: Optional[Text] = '/models/ui_comps/',
                 compLabels: Optional[List[Text]] = None,
        ...
        self.path_ui_comp_data = path_ui_comp_data
        self.path_ui_comp_models = path_ui_comp_models
        if not compLabels:
            self.compLabels = ['Text Button', 'Icon', 'Layout', 'List Item',
                               'Toolbar', 'Input', 'Card', 'Multi-Tab', 'Radio Button',
                               'Modal', 'Pager Indicator', 'Slider', 'On/Off Switch',
                                'Map View', 'Checkbox', 'Date Picker']
        else:
